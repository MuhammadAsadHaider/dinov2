...
def get_dataloader(batch_size = 10, split="validation"):
    dataset = load_dataset("scene_parse_150", split=split, streaming=True, use_auth_token=True)
...
def main():
    ...
    backbone_name = backbone_archs[args.size]
